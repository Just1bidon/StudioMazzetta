      ...
      {isMenuOpen && (
        <div className="absolute top-[83px] left-0 w-full bg-white shadow-md md:hidden">
          <div className="flex flex-col items-center py-4">
            <Link href={"/"}>
              <button className="py-2" onClick={toggleMenu}>Accueil</button>
            </Link>
            <Link href={"/apartement"}>
              <button className="py-2" onClick={toggleMenu}>Appartement</button>
            </Link>
            <Link href={"/tourism"}>
              <button className="py-2" onClick={toggleMenu}>Toursime</button>
            </Link>
            <Link href={"/contact"}>
              <button className="py-2" onClick={toggleMenu}>Contact</button>
            </Link>
            <div className="py-2">
              <Button
                label="Réserver"
