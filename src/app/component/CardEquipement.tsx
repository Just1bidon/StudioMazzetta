...
export default function EquipmentCard({
  ...
  return (
    ...
    {/* <section className="max-sm:w-full flex max-sm:flex-col items-center sm:flex-row"> */}
      <div
      ...
      >
        ...
        {/* <div className="p-2 rounded-full my-auto">
          <Image src={iconUrl} alt={`${title}-icon`} width={30} height={30} />
        </div> */}
        {/* Card */}
